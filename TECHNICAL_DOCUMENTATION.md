...
- SwiftUI retains the document open/new lifecycle. iOS manual Save As uses a UIKit destination-picker bridge, while existing-file persistence is an explicit security-scoped, file-coordinated replacement initiated from Save.
