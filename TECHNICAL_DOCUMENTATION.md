...
| `PDF Editor/Services/PDFManualSavePreparationService.swift` | Builds pending-text Save candidates on an independent background session, applies content-only rewrites, and verifies the reopened result before publication. |
