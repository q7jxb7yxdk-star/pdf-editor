...
- Undo/Redo uses whole-document byte snapshots; bookmark-only restoration updates the live outline without replacing display pages, whereas AcroForm restoration also restores field state.
