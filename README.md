...
- Extract any page directly from its thumbnail or split the document into one PDF per page. Extracted pages preserve the source page's embedded fonts and visual appearance.
